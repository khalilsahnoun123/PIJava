...
public class StationAdminController implements Initializable {
    ...
    private void handleManageVelos(StationVelo station) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/fi_thnitek/VeloManagement.fxml"));
    ...
    private void handleManageTypes() {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/fi_thnitek/VeloTypeManagement.fxml"));
